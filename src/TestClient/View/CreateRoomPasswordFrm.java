...
public class CreateRoomPasswordFrm extends javax.swing.JFrame {
    ...
    public CreateRoomPasswordFrm() {
        ...
        loadingButton.setIcon(new ImageIcon("src/assets/icon/door_exit.png"));
    }
    ...
    private void loadingButtonActionPerformed(java.awt.event.ActionEvent evt) throws IOException {//GEN-FIRST:event_loadingButtonActionPerformed
    ...
    private void createRoomButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createRoomButtonActionPerformed
        try {
            ...
            Client.clientHandler.write("create-room," + password);
            Client.closeView(Client.View.CREATE_ROOM_PASSWORD);
        } catch (Exception ex) {
